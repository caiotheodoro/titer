...
def main() -> int:
    ...
    card = {
        ...
        "unmet_claims": [
            ...
            "H2: RUN and FALSIFIED (D041). Both conditions fire - FALSE_MERGE is flat in collision degree (0.0000 / 0.0125 / 0.0000 across low/medium/high, n=80 each) and, net of the measured 12.76% same-human-two-CIK bound, every interval collapses to zero. It was never a budget problem: the W3 random draw left three of four bands empty (D027), and E2's stratified draw resolved it for $0.",
